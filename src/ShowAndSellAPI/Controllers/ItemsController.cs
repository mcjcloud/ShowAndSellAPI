...
namespace ShowAndSellAPI.Controllers
{
    ...
    public class ItemsController : Controller
    {
        ...
        {
            return new ObjectResult(_context.Items.Where(e => e.Name.Contains(name) && e.GroupId.Equals(groupId)).ToArray());
        }
        ...
        {
            return new ObjectResult(_context.Items.Where(e => e.Name.Contains(name)).ToArray());
        }
        ...
        {
            return new ObjectResult(_context.Items.Where(e => e.GroupId.Equals(groupId)).ToArray());
        }
        ...
        {
            return new ObjectResult(_context.Items.Where(e => e.GroupId.Equals(groupId) && e.Approved).ToArray());
        }
        ...
        public IActionResult Update([FromQuery]string id, [FromBody]UpdateItemRequest itemRequest, [FromQuery]string adminPassword)
        {
            ...
            if (pass != adminPassword) return Unauthorized();
